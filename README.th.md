...
├── policies/                    # ไฟล์นโยบาย 9 ฉบับ (§1–§9)├── team_chat/                   # บันทึกการสื่อสารระหว่างทีม + Cipher├── agents/                      # นิยามทีม 5 ทีม├── rules/                       # 7 ไฟล์กฎตามเส้นทาง└── skills/                      # Slash command ที่กำหนดเอง
